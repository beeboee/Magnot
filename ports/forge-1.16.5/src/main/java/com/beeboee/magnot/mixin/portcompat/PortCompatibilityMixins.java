...
abstract class ItemCollectorsMixin {
    ...
    private <T extends Entity> List<T> magnot$filterCollectorItems(
            World world,
            Class<T> type,
            AxisAlignedBB box,
        ...
        if (!(world instanceof ServerWorld) || !ItemEntity.class.isAssignableFrom(type)) {
            return candidates;
        }
        ...
        return candidates.stream()
                .filter(candidate -> !(candidate instanceof ItemEntity)
                        || !FerrousMagnetRules.blocksItemPull(serverWorld, source, (ItemEntity) candidate))
...
abstract class MobGrindingUtilsMixin {
    ...
    private <T extends Entity> List<T> magnot$filterHopperItems(
            World world,
            Class<T> type,
            AxisAlignedBB box,
            Predicate<? super T> predicate
...
abstract class ModularRoutersMixin {
    ...
    private <T extends Entity> List<T> magnot$filterRouterItems(
            World world,
            Class<T> type,
            AxisAlignedBB box,
...
abstract class ReliquaryMixin {
    ...
    private <T extends Entity> List<T> magnot$filterPlayerItems(
            World world,
            Class<T> type,
            AxisAlignedBB box,
            World originalWorld,
