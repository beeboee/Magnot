...
public final class MagnotItems {
    ...
    public static final RegistryObject<Item> FERROUS_PASTE = ITEMS.register("ferrous_paste", () -> new Item(new Item.Properties()));
    public static final RegistryObject<FerrousTubeItem> FERROUS_TUBE = ITEMS.register(
            "ferrous_tube",
            () -> new FerrousTubeItem(new Item.Properties().stacksTo(1).durability(99))
    );
